...
<div id="footer-center1">&copy; 2016-<?php echo date("Y");?> Aplikasi Sistem Informasi Desa </a> <a target="_blank" href="https://github.com/OpenSID/OpenSID/releases">OpenSID</a> versi <?php echo AmbilVersi()?> dikembangkan oleh Perkumpulan Desa Digital Terbuka<a target="_blank" href="https://opendesa.id/"> OpenDESA</a> <br />Tema Sered_stdr ini dibuat oleh <a href="https://www.facebook.com/parso.widodo" target="_blank">PARSO </a><br/> Dikelola oleh: Pemerintah <?php echo ucwords($this->setting->sebutan_desa)?> <?php echo unpenetration($desa['nama_desa'])?>. </div>
