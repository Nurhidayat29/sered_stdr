			...
			<div>
				<ul class="artikel-list artikel-list-in-box">
					<?php foreach ($artikel as $data): ?>
						<?php $abstrak = potong_teks($data['isi'], 900) ?>
						<li class="artikel">
							<h3 class="judul">
							...
							<div class="teks">
								...
								<div class="img">
									...
									<?= $abstrak ?>
									<a href="<?= site_url('first/artikel/'.$data['thn'].'/'.$data['bln'].'/'.$data['hri'].'/'.$data['slug']) ?>"><div class="readmore">Selengkapnya <i class="fa fa-arrow-right"></i></a></div></a>
								</div>
